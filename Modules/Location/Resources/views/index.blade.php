    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <button class="btn btn-primary btn-sm" onclick="showStoreFormModal('Add New location','Save')">
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('location.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('location.store.or.update')}}";
        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#store_or_update_form #retail_code').val(data.retail_code);
                    $('#store_or_update_form #owner_name').val(data.owner_name);
                    $('#store_or_update_form #postal_code').val(data.postal_code);
                    $('#store_or_update_form #address').val(data.address);
                    $('#store_or_update_form #zone').val(data.zone);
                    $('#store_or_update_form #sales_person').val(data.sales_person);
                    $('#store_or_update_form #phone').val(data.phone);
                    $('#store_or_update_form #division').val(data.division);
                    $('#store_or_update_form #district').val(data.district);
                    $('#store_or_update_form #lat').val(data.lat);
                    $('#store_or_update_form #long').val(data.long);
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('location.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('location.change.status') }}";
