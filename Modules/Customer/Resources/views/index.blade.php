                ...
                <div class="dt-entry__header">
                    ...
                    @if (permission('customer-add'))
                        <button class="btn btn-primary btn-sm"
                                onclick="showFormModal('Add New Content Customer','Save')">
                        ...
                        <form id="form-filter">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="name">Content Customer Name</label>
                                    <input type="text" class="form-control" name="name" id="name"
                                           placeholder="Enter Content Customer Name">
                                </div>
                                <div class="form-group col-md-8 pt-24">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm float-right mr-2"
                                            ...
                                            data-original-title="Filter Data">
