...
class Picture extends BaseModel
{
    ...
    protected $fillable = ['name','gallery_category_id', 'image', 'status', 'created_by', 'updated_by'];
    ...
    private function get_datatable_query()
    {
        if(permission('picture-bulk-delete')){
            $this->column_order = [null,'id','name','gallery_category_id','image','status',null];
        }else{
            $this->column_order = ['id','name','gallery_category_id','image','status',null];
        }
