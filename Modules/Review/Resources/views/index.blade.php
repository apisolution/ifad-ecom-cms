    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <!-- /entry heading -->
                @if (permission('review-add'))
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add New Content review','Save')">
                ...
                <div class="dt-card__body">
                    ...
                    <table id="dataTable" class="table table-striped table-bordered table-hover">
                        <thead class="bg-primary">
                            <tr>
                                @if (permission('review-bulk-delete'))
                                <th>
