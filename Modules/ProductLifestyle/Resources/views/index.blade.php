...
@include('productlifestyle::modal')
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('limage.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
                data._token      = _token;
            }
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('limage.store.or.update')}}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.lifestyle_image){
                        var lifestyle_image = "{{ asset('storage/'.PRODUCT_LIFESTYLE_MULTI_IMAGE_PATH)}}/"+data.lifestyle_image;
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('limage.bulk.delete')}}";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let name  = $(this).data('name');
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('limage.change.status') }}";
